...
:func:`seda.text.technical_tokens.restore` catches missing/duplicated/
...
from seda.text.technical_tokens import PH_PATTERN, TokenRegistry, placeholder_for
...
def edit_ratio(input_text: str, output_text: str) -> float:
    ...
    signal recorded alongside the other :class:`~seda.cleanup.base.CleanupMetrics`.
    """
    if not input_text:
        return 0.0
