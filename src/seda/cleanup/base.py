...
deterministic transcript (see :mod:`seda.cleanup.validation`).
...
:class:`~seda.transcription.base.TranscriptionBackend` pattern.
...
class CleanupProvider(Protocol):
    ...
    def clean(self, transcript: str, mode: str, vocabulary: list[str]) -> str:
        ...
        *vocabulary* is the custom-term list, offered to the model as context.
        ...
        Raises :class:`~seda.errors.CleanupError` on transport/timeout
        failure.
        """
        ...
